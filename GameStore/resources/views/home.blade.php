...
<div class="container pt-5 pb-4 text-center ">
    ...
    <div class="pt-4 pb-4 mt-5 jocuri-categorii">
        ...
        <div class="row">
            <div class="col-md-6">
                <a href="/produse?categorie=3">
                    <img src="../Jocuri de familie5609.png" height="400px">
                </a>
            </div>
            <div class="col-md-6">
                <a href="/produse?categorie=4">
                    <img src="../Jocuri de strategie4577.png" height="400px">
                </a>
            </div>
        </div>

    <a href="/produse"><button class="btn btn-danger mt-5" style="width:200px;">Vezi toate jocurile!</button></a>
    </div>
